...
const recoveryPasswordPatientsController = {};

recoveryPasswordPatientsController.requestCode = async (req, res) => {
    try {
...
recoveryPasswordPatientsController.verifyCode = async (req, res) => {
    try {
        const { code } = req.body;
...
recoveryPasswordPatientsController.newPassword = async (req, res) => {
    try {
...
export default recoveryPasswordPatientsController;